      ...
      body: Column(
        children: [
          Padding(
            ...
            child: BigText(
              text: "Search results for: ${Get.arguments["text"]}",
              size: 16,
                          ...
                          return GestureDetector(
                            onTap: (() {
                              Get.toNamed("/moviedetails", arguments: {
                                "name": controller.searchMovieList[index].name,
                                "desc": controller.searchMovieList[index].desc,
                                "dlink":
                                    controller.searchMovieList[index].dlink,
                                "rating":
                                    controller.searchMovieList[index].rating,
                                "lang": controller.searchMovieList[index].lang,
                                "img":
                                    controller.searchMovieList[index].movieImg,
